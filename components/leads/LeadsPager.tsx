...
export default function LeadsPager({
  ...
  const btn = "inline-flex items-center gap-1 rounded-lg border border-white/10 px-3 py-1.5 text-xs";
  return (
    <div className="flex items-center justify-between text-xs text-neutral-500">
      ...
      <div className="flex items-center gap-2">
        ...
        {page > 1 ? (
          <Link href={href(page - 1)} className={`${btn} text-white hover:bg-white/5`} aria-label="Previous page">
        ...
        {page < pageCount ? (
          <Link href={href(page + 1)} className={`${btn} text-white hover:bg-white/5`} aria-label="Next page">
