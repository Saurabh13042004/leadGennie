...
const COLUMNS = [
  ...
  },
  {
    title: "Compare",
    links: [
      { href: "/compare/apollo", label: "vs Apollo" },
      { href: "/compare/clay", label: "vs Clay" },
      { href: "/compare/instantly", label: "vs Instantly" },
      ...
      <div className="mx-auto max-w-6xl px-5">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-[1.3fr_1fr_1fr_1fr]">
          <div>
            ...
            <p className="max-w-xs text-sm leading-relaxed text-neutral-500">More conversations. More revenue.</p>
          </div>
        ...
        <div className="mt-12 flex flex-col items-start justify-between gap-4 border-t border-neutral-200 pt-6 text-xs text-neutral-400 sm:flex-row sm:items-center">
          <span>© {new Date().getFullYear()} LeadGennie. All rights reserved.</span>
