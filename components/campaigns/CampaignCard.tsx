...
import { Play, Pause, ArrowUpRight, Loader2 } from "lucide-react";
  ...
  return (
    <div className="rounded-xl border border-white/10 bg-[#0A0A0A] p-5 flex flex-col gap-4">
      ...
      <div className="flex items-center gap-2 pt-1 border-t border-white/5">
        {status === "draft" ? (
          <button className="flex-1 text-sm text-white bg-white/5 hover:bg-white/10 rounded-lg px-3 py-2 transition-colors">
            Continue setup
          </button>
        ) : (
          <button
        ...
        <button className="flex items-center gap-1.5 text-sm text-neutral-400 hover:text-white rounded-lg px-3 py-2 transition-colors">
          View analytics
